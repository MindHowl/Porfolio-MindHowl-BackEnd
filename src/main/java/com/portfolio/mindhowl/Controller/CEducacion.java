...
import com.portfolio.mindhowl.Dto.dtoEducacion;
import com.portfolio.mindhowl.Entity.Educacion;
import com.portfolio.mindhowl.Security.Controller.Mensaje;
import com.portfolio.mindhowl.Service.SEducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        Educacion educacion = new Educacion(
                dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE(), dtoeducacion.getFechaE(), dtoeducacion.getTituloE(), dtoeducacion.getImgInstE()
            );
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        educacion.setImgInstE(dtoeducacion.getImgInstE());
